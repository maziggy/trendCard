    ...
    setConfig(config) {
        ...
        root.innerHTML = `
            <style>
                ...
                .metric-item .icon {
                    color: #f5b200;
                    --mdc-icon-size: 18px; /* Adjust the icon size */
                    margin-right: 4px; /* Adjust spacing if needed */
                }
            ...
            <div class="main-container">
                <div class="header-container">
                    ...
                    <div class="metrics">
                        <div class="metric-item" id="interval-metric" data-entity="${this.config.interval}">
                            <ha-icon class="icon" icon="mdi:eye"></ha-icon>
                            <span id="interval-value">10</span>
                        </div>
                        <div class="metric-item" id="steps-metric" data-entity="${this.config.steps}">
                ...
                <div class="trend-cards">
                    <div class="trend-card" id="temp-card" data-entity="${this.config.temperature_delta}">
                    ...
                    <div class="trend-card" id="hum-card" data-entity="${this.config.humidity_delta}">
                ...
                <div class="trend-card" id="vpd-card" data-entity="${this.config.vpd_delta}">
        ...
        // Add event listeners for each metric to open the more-info dialog
        this.shadowRoot.querySelectorAll('.metric-item').forEach(metric => {
            const entityId = metric.getAttribute('data-entity');
            if (entityId) {
                metric.addEventListener('click', () => this._showMoreInfo(entityId));
            }
        });

        // Add event listeners for each trend card to open the more-info dialog
        this.shadowRoot.querySelectorAll('.trend-card').forEach(card => {
            const entityId = card.getAttribute('data-entity');
            if (entityId) {
                card.addEventListener('click', () => this._showMoreInfo(entityId));
            }
        });
    }
